...
var Layout = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        var backurl = [];
        var hrefurl = undefined; //当前URL
        var isback = false;
        function pushBackUrl(url) {
        	 if(hrefurl && isback==false) {
        		 if(url!=hrefurl) {
        			 backurl.push(hrefurl); 
        			 $("#trig-back").show();  
        		 }
             }
        	 hrefurl = url;
        ...
        $('.page-sidebar').on('click', ' li > a.ajaxify', function (e) {
            ...
            if(the.attr('data-load')=='IFRAME') {
            	pageContentBody.html('<div class="row" style="display:block;"><iframe id="iframepage" scrolling="yes" frameborder="no" src="'+ url +'" width="100%"  onload="CLOUD.iFrameHeight()" style="display:block;"></iframe></div>'); 
	            ...
	            $.ajax({
	                ...
	                success: function (res) {
	                    ...
	                    pushBackUrl({type:'menu', url:hash}); 
	                },
        ...
        jQuery('.hor-menu').on('click', ' li > a.ajaxify', function (e) {
            ...
            Metronic.scrollTop();
            var url = $(this).attr("href");
            var menuContainer = jQuery('li.active');
            var pageContentBody = $('.page-content .page-content-body');

            menuContainer.removeClass('active');
            menuContainer.children('span').removeClass('selected');

            $(this).parents('li').each(function () {
                $(this).addClass('active');
                $(this).children('a > span').addClass('selected');
            });
            $(this).parents('li').addClass('active');
