...
<div class="trig-search">
		<form class="form form-inline " role="form" id="trig-search-form">
			<div class="form-group">
				<input type="text" class="form-control"  placeholder="用户名"  id="sfl_username"/>
			</div>
			<div class="form-group">
				<button type="submit" class="btn green " onclick="return false;" id="findSysFunctionLog">
			...
			<div class="portlet-body trig-table-body" >
				<div class="table-toolbar" >
					<div class="row">
						<div class="col-md-12">
							<div class="btn-group">
								<button id="deleteSysFunctionLog" class="btn green trig-privbtn" privkey="deleteSysFunctionLog">删除</button> 
							</div>
							<div class="btn-group">
								<button id="deletesSysFunctionLog" class="btn green trig-privbtn" privkey="deletesSysFunctionLog">删除查询</button> 
							</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/assets/admin/cloud/system/function_log.js"></script>