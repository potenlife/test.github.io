...
<link rel="stylesheet" type="text/css" href="<%=path%>/assets/global/plugins/jquery-nestable/jquery.nestable.css"/>
...
<link rel="stylesheet" href="assets/admin/codemirror/addon/hint/show-hint.css" />
<style type="text/css">
...
<script src="assets/admin/codemirror/mode/sql/sql.js"></script>
...
<script src="assets/admin/codemirror/addon/hint/show-hint.js"></script>
<script src="assets/admin/codemirror/addon/hint/sql-hint.js"></script>
<script src="assets/admin/codemirror/addon/hint/xml-hint.js"></script>
<script src="assets/admin/codemirror/addon/hint/html-hint.js"></script>
<script src="assets/admin/codemirror/addon/hint/javascript-hint.js"></script>
</head>
<!-- END HEAD -->
...
<div class="page-header -i navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		<!-- BEGIN LOGO -->
		<div class="page-logo">
			<img src="assets/admin/layout/img/logo.png" alt="logo" height="45px">
			...
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
					...
					<ul class="dropdown-menu">
						...
						<li>
							<a href="lock.htm">
							<i class="icon-lock"></i> 锁定 <span style="float:right">Ctrl+l</span></a>
						</li>
						<li>
							<a href="javascript:logout();">
							<i class="icon-key"></i> 退出 <span style="float:right">Ctrl+o</span></a>
						</li>
					</ul>
				</li>
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-slide-speed="200" data-auto-scroll="true"  data-keep-expanded="false">
				...
				<li class="sidebar-search-wrapper">
					...
					<form class="sidebar-search "  onsubmit="fullsearch();return false;">
...
<div class="modal" id="ajax-modal-loading" tabindex="-1" role="dialog"  aria-labelledby="remoteModalLabel"  data-keyboard='false' aria-hidden="false" style="z-index:99999">  
...
<script src="<%=path%>/assets/global/plugins/jquery-nestable/jquery.nestable.js"></script>
...
<!-- index include -->
 <s:property value="indexInclude" escape="false"/>
...
jQuery(document).ready(function() {    
	...
	$.post('islogin.json', '' , function(data) { 
		...
		if(data.success==false) {// 未登录
			...
			// 导航是否靠右
			if(data.def && data.def.sud_navigation=='right') {
				$(document.body).addClass("page-sidebar-reversed");
			}
			$(".page-container").show(); 
			// 权限初始
		   setRolePriv(data); 
		   if(data.roles){
			   var superrole = '<c:text key="cloud.superrole"/>';
			   if(superrole)
			   		CLOUD.UserSuperAdmin = data.roles.indexOf(superrole) > -1;
			}
