...
<h3 class="page-title">
	<c:mi key="findDemoFormFull"/>
</h3>
<div class="page-bar">
	<c:navi key="findDemoFormFull"/>  
</div>
				...
				<form action="#" class="form-horizontal" id="demoform" name="demoform">
					<div class="form-body" >
						...
						<div class="form-group">
							...
							<label class="control-label col-md-2">数值3</label>
							<div class="col-md-4">
								<div id="spinner4">
						...
						<div class="form-group">
							...
							<label class="control-label col-md-2">数值</label>
							<div class="col-md-4">
								<div id="spinner1">
						...
						<div class="form-group">
							<label class="control-label col-md-2">数值2</label>
							<div class="col-md-4">
								<div id="spinner3">
									<div class="input-group" style="width:150px;">
										<input type="text" class="spinner-input form-control" maxlength="3" readonly>
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<input type="text" class="form-control"  name="demo_address" > 
								</div>
							</div>
