...
<h3 class="page-title">
	<c:mi key="findDemoFormSearchSelect"/>
</h3>
<div class="page-bar">
	<c:navi key="findDemoFormSearchSelect"/> 
</div>
				...
				<form action="#" class="form-horizontal" id="demoform" name="demoform">
					<div class="form-body" >
						<div class="form-group">
							...
							<div class="col-md-4">
								<select class="form-control select2me" data-placeholder="请选择...">
									<option value=""></option>
						...
						<div class="form-group">
							<label class="control-label col-md-3">搜索(国家)</label>
							<div class="col-md-4">
