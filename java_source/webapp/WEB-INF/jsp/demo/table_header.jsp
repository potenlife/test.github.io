...
<h3 class="page-title">
	<c:mi key="findDemoTableHeader"/>
</h3>
<div class="page-bar">
	<c:navi key="findDemoTableHeader"/> 
</div>
		...
		<div class="trig-table"" >
			<div class="portlet-body trig-table-body" >
				...
				<table class="table table-striped table-bordered table-hover" id="trig-user-table">
					<thead>
					<tr class="trig-table-head-tr">
						<th style="border-bottom:1px solid #ddd; ">选择</th>
						<th colspan="2"  style="border-bottom:1px solid #ddd; ">基本</th> 
						<th colspan="4" style="border-bottom:1px solid #ddd; ">扩展</th> 
					</tr>
					<tr> 
